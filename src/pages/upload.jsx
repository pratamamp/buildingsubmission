    ...
    <div className="w-full h-[calc(100vh_-_9.5rem)] flex justify-center items-center">
      <div className="w-9/12 bg-white rounded-lg shadow-lg shadow-gray-300 font-poppins flex flex-col">
        <div className="flex flex-grow">
          ...
          {loadingFinished && (
            <div
              className="absolute top-[45%] left-1/3 w-1/3 rounded-lg bg-white border-2 space-y-3 px-5 pt-4 divide-y-2 z-50"
              id="notif"
            >
              <div className="flex items-center space-x-3 justify-between">
                <CounterClockIcon className="text-green-500 w-8 h-8" />

...
function SearchPersil() {
    ...
    return (
        <div className="flex">
            <div
                className="w-1/4 bg-gray-50 h-[calc(100vh_-_9.5rem)] px-4 flex flex-col text-[#424242] border-r border-[#D2D2D2]">
                <div className="mt-10">
                ...
                {!dataPersil ? (
                    ...
                    <div className="flex flex-col h-[calc(100vh_-_9.5rem)]">
                        <div
                            className="border-b border-gray-200 font-poppins space-y-2 overflow-y-auto no-scrollbar flex-grow">
                            <div>
